  ...
  return (
    <>
      {todaysTasks.length !== 0 && (
        <div className="mt-8">
          <span className="flex justify-between mb-2">
            <span>Les tâches d'aujourd'hui</span> {todayTasksDone.length}/
            {todaysTasks.length}
          </span>
      ...
      {tasks.length !== 0 && (
        <div className="mt-6">
          <span className="flex justify-between mb-2">
            <span>Toutes les tâches</span> {allTasksDone.length}/{tasks.length}
          </span>
          <div className="barProgress">
      ...
      {todaysTasks.length > 0 && (
        <div className="mt-8">
          <span className="mb-2 block">Les tâches d'aujourd'hui</span>
          <ul>
